...
struct DSI_REGS {
	...
	UINT32 rsv_0198[2];	/* 0198..019c */
	UINT32 DSI_VM_CMD_DATA20;	/* 001A0 */
	UINT32 DSI_VM_CMD_DATA24;	/* 001A4 */
	UINT32 DSI_VM_CMD_DATA28;	/* 001A8 */
	UINT32 DSI_VM_CMD_DATA2C;	/* 001AC */
	UINT32 DSI_VM_CMD_DATA30;	/* 001B0 */
	UINT32 DSI_VM_CMD_DATA34;	/* 001B4 */
	UINT32 DSI_VM_CMD_DATA38;	/* 001B8 */
	UINT32 DSI_VM_CMD_DATA3C;	/* 001BC */
};
