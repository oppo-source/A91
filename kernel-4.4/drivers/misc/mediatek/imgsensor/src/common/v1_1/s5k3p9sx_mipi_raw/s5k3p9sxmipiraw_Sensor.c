...
static imgsensor_info_struct imgsensor_info = {
	...
	.i2c_addr_table = {0x5a, 0x5b, 0x20, 0xff},
};
...
static void write_shutter(kal_uint32 shutter)
{
	...
	LOG_INF("shutter =%d, framelength =%d, bLongShutterFlag:%d\n", shutter,imgsensor.frame_length, bLongShutterFlag );
...
#if 0
/*Caohua.Lin@Camera.Driver 20180620 add for debug after burst mode*/
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x6F12, 0x0000);
	//Caohua.Lin@Camera 20180628 add for modify T5 must be >= 0.1ms in power up sequence
	write_cmos_sensor(0x6028, 0x4000);
	write_cmos_sensor(0xB134, 0x0000);
	write_cmos_sensor(0xB136, 0x0000);
	write_cmos_sensor(0xB138, 0x0000);
	//Caohua.Lin@Camera 20180728 add for modify SHBN
	write_cmos_sensor(0x6028, 0x2000); //
	...
	write_cmos_sensor(0x6F12, 0x0003); //th1 high value
