...
#include "hi846mipiraw3_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.max_framerate = 300,
		.mipi_pixel_rate =  288000000,//360Mbps*4/10=360 000 000 *4/10=144000000
...
{
  { 3264, 2448,	  0, 304, 3264, 1840, 3264, 1840,   0, 0, 3264, 1840, 0, 0, 3264, 1840}, // preview
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == HI846N_SENSOR_ID)
...
UINT32 HI846_MIPI_RAW3_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
