...
#include "s5k4h7mipiraw2_Sensor.h"
//#ifdef VENDOR_EDIT
...
static imgsensor_info_struct imgsensor_info = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr, //SENSOR_OUTPUT_FORMAT_RAW_B,//SENSOR_OUTPUT_FORMAT_RAW_Gb,//SENSOR_OUTPUT_FORMAT_RAW_Gr,
	.mclk = 24,
	.mipi_lane_num = SENSOR_MIPI_4_LANE,
	#ifndef VENDOR_EDIT
	/*Caohua.Lin@Camera.Driver  add for 17175  board 20180205*/
	.i2c_addr_table = {0x5b,0x5a},
	#else
...
{{ 3264, 2448,	  0,	  0,   3264, 2448, 1632, 1224, 0000, 0000, 1632, 1224,	0,	0, 1632, 1224}, // Preview
 ...
 { 3264, 2448,  480,    360,   2304, 1728, 2304, 1728, 0000, 0000, 2304, 1728,  0,      0, 2304, 1728},};//custom1
...
#ifndef VENDOR_EDIT
/*weiriqin@camera.driver on 20190618adjust correct flip and mirror*/
...
static void custom1_setting(void)
{
	...
	write_cmos_sensor_8(0x3906, 0x00);
	write_cmos_sensor_8(0x0344, 0x01);
	write_cmos_sensor_8(0x0345, 0xE8);
	write_cmos_sensor_8(0x0346, 0x01);
	write_cmos_sensor_8(0x0347, 0x70);
	write_cmos_sensor_8(0x0348, 0x0A);
	write_cmos_sensor_8(0x0349, 0xE7);
	write_cmos_sensor_8(0x034A, 0x08);
	...
	write_cmos_sensor_8(0x0341, 0x5E);
	write_cmos_sensor_8(0x0342, 0x0D);
	write_cmos_sensor_8(0x0343, 0xFC);
	write_cmos_sensor_8(0x0200, 0x0D);
	write_cmos_sensor_8(0x0201, 0x6C);
			...
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			LOG_INF("s5k4h7 read_0x0000=0x%x, 0x0001=0x%x,0x0000_0001=0x%x\n",
				read_cmos_sensor_8(0x0000),read_cmos_sensor_8(0x0001),read_cmos_sensor(0x0000));
                        LOG_INF("weiriqin: read out sensor id 0x%x \n", *sensor_id);
...
UINT32 S5K4H7_MIPI_RAW2_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
